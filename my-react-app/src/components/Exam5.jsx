...
import test1 from "../assets/dog5.jpg";
...
// JSX 예제 3 : 로그인 여부에 따라 화마ㅕㄴ 다르게 보이기
...
// JSX 에제 4 : 로그인 여부에 따라 화면 다르게 보이기(삼항 연산자)
const Exam5_4 = (props) => {
...
const Exam5_5 = () => {
    ...
    // JS 내장함수 중 배열을 하나씩 순차 접근해서 콜백함수 내에 있는
    // 내용 수행 후 새로운 배열을 만들어 반환 -> map
